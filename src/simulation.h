...
private:
    ...
    GLuint p2gProg, g2pProg, applyAProg, normalizeProg, classifyCellsProg, resetCellTypesProg, computeDivProg, applyPressureProg, dotProductProg, moveAlphaProg, moveBetaProg, transitionProg, advectLevelSetProg, updateLevelSetProg, particlesLevelSetProg;
